...
// BookSystemDoc.cpp: CBookSystemDoc 类的实现
//
...
// CBookSystemDoc 构造/析构

CBookSystemDoc::CBookSystemDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CBookSystemDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CBookSystemDoc::InitializeSearchContent()
{
...
void CBookSystemDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
